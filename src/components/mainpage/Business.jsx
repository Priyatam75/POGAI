  ...
  <section id="features" className={`${layout.section} justify-center items-start mt-10 bg-[#FDFEFF]`}>
    <div className="flex flex-col sm:flex-row h-auto w-full text-center">
      ...
      <div id="FirstCard" className="flex-1 mb-4 sm:mb-0 sm:mr-1 grid grid-cols-3 ">
        ...
        <div className="flex items-center justify-center border border-1 border-gray-300 rounded-2xl shadow-lg p-5"> 
      ...
      <div id="SecondCard" className="flex-1 mb-4 sm:mb-0 sm:mr-1 grid grid-cols-3">
        ...
        <div className="flex items-center justify-center "></div>
        <div className="flex items-center justify-center border border-1 border-gray-300 rounded-2xl shadow-lg p-3 ">
          <img src={recordsImage} alt="Records" style={{ width: '100%', height: '75%' }} />
        </div>
        <div className="flex items-center justify-center "></div>

        <div className="flex items-center justify-center col-span-3 text-[#FF0000] font-bold text-2xl mt-6">Medical Record</div>
        <div className="flex items-center justify-center col-span-3 text-xl mt-5" style={{ alignItems: 'flex-start' }}>
      ...
      <div id="ThirdCard" className="flex-1 grid grid-cols-3">
        ...
        <div className="flex items-center justify-center "></div>
        <div className="flex items-center justify-center border border-1 border-gray-300 rounded-2xl shadow-lg p-3"> 
          <img src={connectImage} alt="Connect" style={{ width: '100%', height: '75%' }} /> 
        </div>
        <div className="flex items-center justify-center "></div>

        <div className="flex items-center justify-center col-span-3 text-[#FF0000] font-bold text-2xl mt-6">Connect</div>
        <div className="flex items-center justify-center col-span-3 text-xl mt-5" style={{ alignItems: 'flex-start' }}>
